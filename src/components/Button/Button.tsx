...
const ButtonComponent = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const themeStyles = {
      ...
      light2:
        "bg-white text-neutral-800 hover:bg-neutral-800 hover:text-white focus-visible:ring-neutral-300 rounded-full",
      white: "", // white je jen pro secondary, primary s white nemá speciální styly
    };
    ...
    // Logika pro secondary s white theme
    const secondaryTextColor =
      theme === "white" ? "text-white" : "text-golden-gate";

    // Ikona pro secondary variantu
    const secondaryIconSrc =
      theme === "white"
        ? "/icons/system/arrow-up-right-s-white.svg"
        : "/icons/system/arrow-up-right-s-orange.svg";
    ...
    const iconWrapperStyles = {
      ...
      light2:
        "bg-golden-gate rounded-full w-11 h-11 flex justify-center items-center relative transition-colors group-hover:bg-white flex-shrink-0",
      white: "", // PŘIDÁNO - white theme se nepoužívá s primary variantou
    };
    ...
    return (
      <button
        ...
        className={cn(
          baseStyles,
          variant === "primary" ? themeStyles[theme] : "",
          variant === "secondary" ? secondaryTextColor : "",
          variantStyles[variant],
          className
        )}
        {...props}
