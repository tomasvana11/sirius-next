...
export const ClientBanner: React.FC<ClientBannerProps> = ({ className }) => {
  ...
  const banner = {
    Title:
      "Chcete i vy být jedni z klientů, kterým jsme pomohli změnit životy?",
    Description:
      "Za každou referencí je příběh, který začal jedním rozhodnutím. Zanechte nám kontakt – a ten váš může začít dnes.",
    Url: "/spoluprace#formular",
  };
