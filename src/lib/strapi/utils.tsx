...
import React from "react";
import type { RichTextNode, StrapiImage } from "./types";
import { Title } from "@/components/Title";
...
/**
 * Získá URL obrázku ze Strapi
 * @param image - Strapi obrázek
 * @param size - Velikost formátu (thumbnail, small, medium, large)
 * @returns URL obrázku nebo null
 */
